// File: ui/components/CollapsibleHeaderScreen.kt - FIXED VERSION
...
fun CollapsibleHeaderScreen(
    ...
    if (showOptions && optionsContent != null) {
        ModalBottomSheet(
            ...
            containerColor = Color.Black, // CHANGED: Solid black background
            dragHandle = {
                ...
                Box(
                    ...
                    Box(
                        modifier = Modifier
                            .height(4.dp)
                            .width(40.dp)
                            .background(Color.White.copy(alpha = 0.3f)) // Visible handle
